 ...
 */
typedef enum protocol_state { IDLE, CLOSED, SYN_SENT, SYN_RECEIVED, ESTABLISHED, CLOSING, CONNECTED } protocol_state;
...
void process_received_PDU(mic_tcp_pdu pdu, mic_tcp_sock_addr addr, int fd);
